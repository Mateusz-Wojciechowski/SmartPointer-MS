...
template<typename T>
CNode<T>::CNode(CNode<T> &&c_other){
    cout << "Move node" << endl;
    t_value = c_other.t_value;
    s_value = c_other.s_value;
    c_parent = c_other.c_parent;
    b_is_operator = c_other.b_is_operator;
    c_children = c_other.c_children;

    c_other.c_parent = NULL;
    c_other.c_children = NULL;
}
